...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1554.6215384417062; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1442.1207259923544; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1936.4414466963965; // x position of the perpendicular encoder (in tick units)
    }
